...
data = td.images.fromtif('/home/subhadip/Codes/zebrafish-neuroimaging/fish', engine=sc)
...
images = td.images.frombinary(
    '/home/subhadip/Codes/zebrafish-neuroimaging/images', order='F', engine=sc)
